/*
This is the final opcode handler and opcode table generated by the code generator program.
*/
...
void  (*m68ki_instruction_jump_table[0x10000])(m68ki_cpu_core *m68k);

/* Cycles used by CPU type */
