...
/*		debugger_instruction_hook(cpustate->device, GET_PC);	*/
		...
		else
		{
			...
			switch (insn >> INSN_COND_SHIFT)
			{
				...
				break;
				case COND_GE:
					if (!(GET_CPSR & N_MASK) != !(GET_CPSR & V_MASK)) /* Use x ^ (x >> ...) method */ goto L_Next;
				break;
				case COND_LT:
			...
			switch ((insn & 0x0F000000) >> 24)
			{
				...
				case 0x03:
				{
					...
					{
						case 0x01000050:	// QADD - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 16) & 0x0f);
							INT64 res = saturate_qbit_overflow(cpustate, (INT64)src1 + (INT64)src2);
							SET_REGISTER(cpustate, (insn >> 12) & 0x0f, (INT32)res);
							R15 += 4;

							goto JumpOut;
						}
						case 0x01200050:	// QSUB - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 16) & 0x0f);
							INT64 res = saturate_qbit_overflow(cpustate, (INT64)src1 - (INT64)src2);
						...
						case 0x01400050:	// QDADD - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 16) & 0x0f);
							// check if doubling operation will overflow
							INT64 res = (INT64)src2 * 2;
					...
					{
						case 0x01000080:	// SMLAxy - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 8) & 0x0f);
							INT32 res1;
							...
							saturate_qbit_overflow(cpustate, (INT64)res1 + (INT64)GET_REGISTER(cpustate, (insn >> 12) & 0x0f));
							SET_REGISTER(cpustate, (insn >> 16) & 0x0f, res1 + GET_REGISTER(cpustate, (insn >> 12) & 0x0f));
							R15 += 4;

							goto JumpOut;
						}
						case 0x01400080:	// SMLALxy - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 8) & 0x0f);
							INT64 dst;
							...
							dst = (INT64)GET_REGISTER(cpustate, (insn >> 12) & 0x0f);
							dst |= (INT64)GET_REGISTER(cpustate, (insn >> 16) & 0x0f) << 32;
							// do the multiply and accumulate
							dst += (INT64)src1 * (INT64)src2;
							// write back the result
							SET_REGISTER(cpustart, (insn >> 12) & 0x0f, (UINT32)(dst & 0xffffffff));
							SET_REGISTER(cpustart, (insn >> 16) & 0x0f, (UINT32)(dst >> 32));

							goto JumpOut;
						}
						case 0x01600080:	// SMULxy - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 8) & 0x0f);
							INT32 res;
							...
							res = src1 * src2;
							SET_REGISTER(cpustart, (insn >> 16) & 0x0f, res);
					...
					switch (insn & 0x0ff000b0)
					{
						case 0x012000a0:	// SMULWy - v5
						{
							...
							res >>= 16;
							SET_REGISTER(cpustart, (insn >> 16) & 0x0f, (UINT32)res);

							goto JumpOut;
						}
						case 0x01200080:	// SMLAWy - v5
						{
							INT32 src1 = GET_REGISTER(cpustate, insn & 0x0f);
							INT32 src2 = GET_REGISTER(cpustate, (insn >> 8) & 0x0f);
							INT32 src3 = GET_REGISTER(cpustate, (insn >> 12) & 0x0f);
							INT64 res;
					...
					else if ((insn & 0x0e000000) == 0 && (insn & 0x80) && (insn & 0x10))  // bits 27-25=000 bit 7=1 bit 4=1
					{
						/* Half Word Data Transfer */
						if (insn & 0x60)         // bits = 6-5 != 00
							HandleHalfWordDT(cpustate, insn);
						/* Swap */
						else if (insn & 0x01000000)   // bit 24 = 1
