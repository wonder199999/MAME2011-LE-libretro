...
static INTERRUPT_GEN( cps2_interrupt )
{
	...
	if ( (!state->scancalls && state->scanline1 < state->scancount) || state->scanline1 == state->scancount )
	{
		...
		/* visarea.min_y - [first visible line?] + scancount */
		device->machine->primary_screen->update_partial(16 - 10 + state->scancount);
		state->scancalls++;
	}
	/* raster effects */
...
static MACHINE_START( cps2 )
{
	...
	if (state->audiocpu != NULL)	/* gigaman2 has no audiocpu */
		memory_configure_bank(machine, "bank1", 0, (QSOUND_SIZE - 0x10000) / 0x4000,
			memory_region(machine, "audiocpu") + 0x10000, 0x4000);
}
...
ROM_START( 1944 )	/* 1944 - The Loop Master (2000.06.20, USA) */
...
ROM_START( 1944j )	/* 1944 - The Loop Master (2000.06.20, Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xx )	/* 19XX - the war against destiny (1995.12.07, USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxj )	/* 19XX - the war against destiny (1996.01.04, Japan, Yellow case) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxjr1 )	/* 19XX - the war against destiny (1995.12.25, Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxjr2 )	/* 19XX - the war against destiny (1995.12.07, Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxa )	/* 19XX - the war against destiny (1996.01.04, Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxar1 )	/* 19XX - the war against destiny (1995.12.07, Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxh )	/* 19XX - the war against destiny (1995.12.18, Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxb )	/* 19XX - the war against destiny (1995.12.18, Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwar )	/* Armored Warriors (1994.10.24, Europe) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwarr1 )	/* Armored Warriors (1994.10.11, Europe) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwaru )	/* Armored Warriors (1994.10.24, USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwaru1 )	/* Armored Warriors (1994.09.20, USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pgear )	/* Powered Gear - strategic variant armor equipment (1994.10.24, Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pgearr1 )	/* Powered Gear - strategic variant armor equipment (1994.09.16, Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwara )	/* Armored Warriors (1994.10.24, Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwarar1 )	/* Armored Warriors (1994.09.20, Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avsp )	/* Alien vs Predator (1994.05.20 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avspu )	/* Alien vs Predator (1994.05.20 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avspj )	/* Alien vs Predator (1994.05.20 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avspa )	/* Alien vs Predator (1994.05.20 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avsph )	/* Alien vs Predator (1994.05.20 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( batcir )	/* Battle Circuit (1997.03.19 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( batcirj )	/* Battle Circuit (1997.03.19 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( batcira )	/* Battle Circuit (1997.03.19 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( choko )	/* Choko (2001.08.20 Japan) */
...
ROM_START( csclub )	/* Capcom Sports Club (1997.10.17 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( csclub1 )	/* Capcom Sports Club (1997.07.22 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( csclubj )	/* Capcom Sports Club (1997.07.22 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( csclubjy )	/* Capcom Sports Club (1997.07.22 Japan, Yellow case) */
...
ROM_START( cscluba )	/* Capcom Sports Club (1997.07.22 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( csclubh )	/* Capcom Sports Club (1997.07.22 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( cybots )	/* Cyberbots - fullmetal madness (1995.04.24 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( cybotsu )	/* Cyberbots - fullmetal madness (1995.04.24 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( cybotsj )	/* Cyberbots - fullmetal madness (1995.04.20 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtod )	/* Dungeons & Dragons - tower of doom (1994.04.12 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodr1 )	/* Dungeons & Dragons - tower of doom (1994.01.13 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodu )	/* Dungeons & Dragons - tower of doom (1994.01.25 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodur1 )	/* Dungeons & Dragons - tower of doom (1994.01.13 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodj )	/* Dungeons & Dragons - tower of doom (1994.04.12 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodjr1 )	/* Dungeons & Dragons - tower of doom (1994.01.25 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodjr2 )	/* Dungeons & Dragons - tower of doom (1994.01.13 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtoda )	/* Dungeons & Dragons - tower of doom (1994.04.12 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodar1 )	/* Dungeons & Dragons - tower of doom (1994.01.13 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodh )	/* Dungeons & Dragons - tower of doom (1994.04.12 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodhr1 )	/* Dungeons & Dragons - tower of doom (1994.01.25 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodhr2 )	/* Dungeons & Dragons - tower of doom (1994.01.13 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsom )	/* Dungeons & Dragons - shadow over mystara (1996.06.19 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomr1 )	/* Dungeons & Dragons - shadow over mystara (1996.02.23 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomr2 )	/* Dungeons & Dragons - shadow over mystara (1996.02.09 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomr3 )	/* Dungeons & Dragons - shadow over mystara (1996.02.08 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomu )	/* Dungeons & Dragons - shadow over mystara (1996.06.19 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomur1 )	/* Dungeons & Dragons - shadow over mystara (1996.02.09 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomj )	/* Dungeons & Dragons - shadow over mystara (1996.06.19 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomjr1 )	/* Dungeons & Dragons - shadow over mystara (1996.02.06 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsoma )	/* Dungeons & Dragons - shadow over mystara (1996.06.19 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomar1 )	/* Dungeons & Dragons - shadow over mystara (1996.02.08 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomb )	/* Dungeons & Dragons - shadow over mystara (1996.02.23 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomh )	/* Dungeons & Dragons - shadow over mystara (1996.02.23 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dimahoo )	/* Dimahoo (2000.01.21 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dimahoou )	/* Dimahoo (2000.01.21 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gmahou )	/* Great Mahou Daisakusen (2000.01.21, Japan)(clone of dimahoo) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlk )	/* Darkstalkers - the night warriors (1994.07.05 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlku )	/* Darkstalkers - the night warriors (1994.08.18 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlkur1 )	/* Darkstalkers - the night warriors (1994.07.05 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vampj )	/* Vampire - the night warriors (1994.07.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vampja )	/* Vampire - the night warriors (1994.07.05 Japan, alt) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vampjr1 )	/* Vampire - the night warriors (1994.06.30 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlka )	/* Darkstalkers - the night warriors (1994.07.05 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlkh )	/* Darkstalkers - the night warriors (1994.08.18 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtr )	/* Eco Fighters (1993.12.03 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtru )	/* Eco Fighters (1994.02.15 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtru1 )	/* Eco Fighters (1993.12.03 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( uecology )	/* Ultimate Ecology (1993.12.03 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtra )	/* Eco Fighters (1993.12.03 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtrh )	/* Eco Fighters (1993.12.03 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawing )	/* Giga Wing (1999.02.22 USA) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawingj )	/* Giga Wing (1999.02.23 Japan) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawinga )	/* Giga Wing (1999.02.22 Asia) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawingh )	/* Giga Wing (1999.02.22 Hispanic) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawingb )	/* Giga Wing (1999.02.22 Brazil) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( hsf2 )	/* Hyper Street Fighters II: The Anniversary Edition (2004.02.02 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( hsf2a )	/* Hyper Street Fighters II: The Anniversary Edition (2004.02.02 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( hsf2j )	/* Hyper Street Fighters II: The Anniversary Edition (2003.12.22 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( jyangoku )	/* Jyangokushi (1999.05.27 Japan) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( megaman2 )	/* Mega Man 2 - the power fighters (1996.07.08 USA) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( megaman2a )	/* Mega Man 2 - the power fighters (1996.07.08 Asia) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( rockman2j )	/* Rockman 2 - the power fighters (1996.07.08 Japan) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( megaman2h )	/* Mega Man 2 - the power fighters (1996.07.12 Hispanic) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigaman2 )		/* Gigaman2: The Power Fighters (bootleg) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mmatrix )	/* Mars Matrix (2000.04.12 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mmatrixj )	/* Mars Matrix (2000.04.12 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( msh )	/* Marvel Super Heroes (1995.10.24 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshu )	/* Marvel Super Heroes (1995.10.24 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshj )	/* Marvel Super Heroes (1995.11.17 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshjr1 )	/* Marvel Super Heroes (1995.10.24 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( msha )	/* Marvel Super Heroes (1995.10.24 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshh )	/* Marvel Super Heroes (1995.11.17 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshb )	/* Marvel Super Heroes (1995.11.17 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsf )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfu )	/* Marvel Super Heroes vs Street Fighters (1997.08.27 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfu1 )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfj )	/* Marvel Super Heroes vs Street Fighters (1997.07.07 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfj1 )	/* Marvel Super Heroes vs Street Fighters (1997.07.02 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfj2 )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfh )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfa )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfa1 )	/* Marvel Super Heroes vs Street Fighters (1997.06.20 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfb )	/* Marvel Super Heroes vs Street Fighters (1997.08.27 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfb1 )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvsc )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscr1 )	/* Marvel vs Capcom - clash of super heroes (1998.01.12 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscu )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscur1 )	/* Marvel vs Capcom - clash of super heroes (1997.12.22 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscj )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscjr1 )	/* Marvel vs Capcom - clash of super heroes (1998.01.12 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscjsing )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Japan, single PCB) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvsca )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscar1 )	/* Marvel vs Capcom - clash of super heroes (1998.01.12 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvsch )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscb )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mpang )	/* Mighty! Pang (2000.10.10 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mpangr1 )	/* Mighty! Pang (2000.09.25 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mpangu )	/* Mighty! Pang (2000.10.10 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mpangj )	/* Mighty! Pang (2000.10.11 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarr )	/* Night Warriors - darkstalkers' revenge (1995.03.16 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarru )	/* Night Warriors - darkstalkers' revenge (1995.04.06 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarrh )	/* Night Warriors - darkstalkers' revenge (1995.04.03 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarrb )	/* Night Warriors - darkstalkers' revenge (1995.04.03 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarra )	/* Night Warriors - darkstalkers' revenge (1995.03.02 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhuntj )	/* Vampire Hunter - darkstalkers' revenge (1995.03.16 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhuntjr1s )	/* Vampire Hunter - darkstalkers' revenge (1995.03.07 Japan stop version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhuntjr1 )	/* Vampire Hunter - darkstalkers' revenge (1995.03.07 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhuntjr2 )	/* Vampire Hunter - darkstalkers' revenge (1995.03.02 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progear )	/* Progear (2001.01.17 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progearj )	/* Progear No Arashi (2001.01.17 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progeara )	/* Progear (2001.01.17 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pzloop2 )	/* Puzz Loop 2 (2001.03.02 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pzloop2j )	/* Puzz Loop 2 (2001.02.26 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pzloop2jr1 )	/* Puzz Loop 2 (2001.02.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( qndream )	/* Quiz Nanairo Dreams - nijiirochou no kiseki (1996.08.26) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ringdest )	/* Ring of Destruction - slammasters II (1994.09.02 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( smbomb )	/* Super Muscle Bomber - the international blowout (94.08.31 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( smbombr1 )	/* Super Muscle Bomber - the international blowout (94.08.08 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ringdesta )	/* Ring of Destruction - slammasters II (1994.08.31 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ringdesth )	/* Ring of Destruction - slammasters II (1994.09.02 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mmancp2u )	/* Mega Man - The Power Battle (1995.10.06 USA, SAMPLE Version) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mmancp2ur1 )	/* Mega Man - The Power Battle (1995.09.26 USA, SAMPLE Version) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( rmancp2j )	/* Rockman: The Power Battle (1995.09.22 Japan) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa )	/* Street Fighter Alpha - warriors' dreams (1995.07.27 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfar1 )	/* Street Fighter Alpha - warriors' dreams (1995.07.18 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfar2 )	/* Street Fighter Alpha - warriors' dreams (1995.06.27 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfar3 )	/* Street Fighter Alpha - warriors' dreams (1995.06.05 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfau )	/* Street Fighter Alpha - warriors' dreams (1995.06.27 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfza )	/* Street Fighter Zero (1995.06.27 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzar1 )	/* Street Fighter Zero (1995.06.05 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzj )	/* Street Fighter Zero (1995.07.27 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzjr1 )	/* Street Fighter Zero (1995.06.27 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzjr2 )	/* Street Fighter Zero (1995.06.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzh )	/* Street Fighter Zero (1995.07.18 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzhr1 )	/* Street Fighter Zero (1995.06.27 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzb )	/* Street Fighter Zero (1995.11.09 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfzbr1 )	/* Street Fighter Zero (1995.07.27 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa2 )	/* Street Fighter Alpha 2 (1996.02.29 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa2u )	/* Street Fighter Alpha 2 (1996.04.30 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa2ur1 )	/* Street Fighter Alpha 2 (1996.03.06 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2j )	/* Street Fighter Zero 2 (1996.04.30 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2jr1 )	/* Street Fighter Zero 2 (1996.02.27 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2a )	/* Street Fighter Zero 2 (1996.02.27 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2b )	/* Street Fighter Zero 2 (1996.05.31 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2br1 )	/* Street Fighter Zero 2 (1996.03.04 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2h )	/* Street Fighter Zero 2 (1996.03.04 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2n )	/* Street Fighter Zero 2 (1996.02.29 Oceania) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2al )	/* Street Fighter Zero 2 Alpha (1996.08.26 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2alj )	/* Street Fighter Zero 2 Alpha (1996.08.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2alh )	/* Street Fighter Zero 2 Alpha (1996.08.13 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2alb )	/* Street Fighter Zero 2 Alpha (1996.08.13 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3 )	/* Street Fighter Alpha 3 (1998.09.04 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3u )	/* Street Fighter Alpha 3 (1998.09.04 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3ur1 )	/* Street Fighter Alpha 3 (1998.06.29 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3us )	/* Street Fighter Alpha 3 (1998.06.16 USA, Sample Version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3j )	/* Street Fighter Zero 3 (1998.09.04 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3jr1 )	/* Street Fighter Zero 3 (1998.07.27 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3jr2 )	/* Street Fighter Zero 3 (1998.06.29 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3a )	/* Street Fighter Zero 3 (1998.09.04 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3ar1 )	/* Street Fighter Zero 3 (1998.07.01 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3h )	/* Street Fighter Alpha 3 (1998.09.04 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3hr1 )	/* Street Fighter Alpha 3 (1998.06.29 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3b )	/* Street Fighter Alpha 3 (1998.06.29 Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sgemf )	/* Super Gem Fighter Mini Mix (1997.09.04) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( pfghtj )	/* Pocket Fighter (1997.09.04 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sgemfa )	/* Super Gem Fighter Mini Mix (1997.09.04 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sgemfh )	/* Super Gem Fighter Mini Mix (1997.09.04 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2t )	/* Super Puzzle Fighter II Turbo (1996.05.29 Euro) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2tu )	/* Super Puzzle Fighter II Turbo (1996.06.20 USA) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2xj )	/* Super Puzzle Fighter II Turbo (1996.05.31 Japan) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2ta )	/* Super Puzzle Fighter II Turbo (1996.05.29 Asia) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2th )	/* Super Puzzle Fighter II Turbo (1996.05.31 Hispanic) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2 )	/* Super Street Fighter II - the new challengers (1993.10.05 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2r1 )	/* Super Street Fighter II - the new challengers (1993.09.11 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2u )	/* Super Street Fighter II - the new challengers (1993.09.11 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2a )	/* Super Street Fighter II - the new challengers (1993.10.05 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2ar1 )	/* Super Street Fighter II - the new challengers (1993.09.14 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2j )	/* Super Street Fighter II - the new challengers (1993.10.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2jr1 )	/* Super Street Fighter II - the new challengers (1993.09.11 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2jr2 )	/* Super Street Fighter II - the new challengers (1993.09.10 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2h )	/* Super Street Fighter II - the new challengers (1993.09.11 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tb )	/* Super Street Fighter II - the tournament battle (1993.11.19 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tbr1 )	/* Super Street Fighter II - the tournament battle (1993.09.11 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tbj )	/* Super Street Fighter II - the tournament battle (1993.09.11 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tbh )	/* Super Street Fighter II - the tournament battle (1993.10.05 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2t )	/* Super Street Fighter II Turbo (1994.02.23 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tu )	/* Super Street Fighter II Turbo (1994.03.23 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tur1 )	/* Super Street Fighter II Turbo (1994.02.23 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2ta )	/* Super Street Fighter II Turbo (1994.02.23 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2th )	/* Super Street Fighter II Turbo (1994.02.23 ETC) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2xj )	/* Super Street Fighter II X - grand master challenge (1994.02.23 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2xjr )	/* Super Street Fighter II X - grand master challenge (1994.02.23 Japan rent version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhunt2 )	/* Vampire Hunter 2 - darkstalkers revenge (1997.09.29 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhunt2r1 )	/* Vampire Hunter 2 - darkstalkers revenge (1997.09.13 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsav )	/* Vampire Savior - the lord of vampire (1997.05.19 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsavu )	/* Vampire Savior - the lord of vampire (1997.05.19 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsavj )	/* Vampire Savior - the lord of vampire (1997.05.19 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsava )	/* Vampire Savior - the lord of vampire (1997.05.19 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsavh )	/* Vampire Savior - the lord of vampire (1997.05.19 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsav2 )	/* Vampire Savior 2 - the lord of vampire (1997.09.13 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcota )	/* X-Men - children of the atom (1995.03.31 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotar1 )	/* X-Men - children of the atom (1995.01.05 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotau )	/* X-Men - children of the atom (1995.01.05 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotah )	/* X-Men - children of the atom (1995.03.31 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotahr1 )	/* X-Men - children of the atom (1995.01.05 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaj )	/* X-Men - children of the atom (1995.01.05 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaj1 )	/* X-Men - children of the atom (1994.12.22 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaj2 )	/* X-Men - children of the atom (1994.12.19 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaj3 )	/* X-Men - children of the atom (1994.12.17 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotajr )	/* X-Men - children of the atom (1994.12.08 Japan, rent version) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaa )	/* X-Men - children of the atom (1995.01.05 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotaar1 )	/* X-Men - children of the atom (1994.12.17 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsf )	/* X-Men vs Street Fighter (1996.10.04 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfr1 )	/* X-Men vs Street Fighter (1996.09.10 Euro) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfu )	/* X-Men vs Street Fighter (1996.10.23 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfur1 )	/* X-Men vs Street Fighter (1996.10.04 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfur2 )	/* X-Men vs Street Fighter (1996.09.10 USA) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfj )	/* X-Men vs Street Fighter (1996.10.04 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfjr1 )	/* X-Men vs Street Fighter (1996.09.10 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfjr2 )	/* X-Men vs Street Fighter (1996.09.09 Japan) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfa )	/* X-Men vs Street Fighter (1996.10.23 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfar1 )	/* X-Men vs Street Fighter (1996.10.04 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfar2 )	/* X-Men vs Street Fighter (1996.09.19 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfar3 )	/* X-Men vs Street Fighter (1996.09.10 Asia) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfh )	/* X-Men vs Street Fighter (1996.10.04 Hispanic) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfb )	/* X-Men vs Street Fighter (1996.10.23  Brazil) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
*/
GAME( 1993, ssf2,       0,        cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Super Street Fighter II: The New Challengers (World 931005)", GAME_SUPPORTS_SAVE )
GAME( 1993, ssf2r1,     ssf2,     cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Super Street Fighter II: The New Challengers (World 930911)", GAME_SUPPORTS_SAVE )
...
GAME( 1993, ddtoda,     ddtod,    cps2, cps2_4p4b, cps2,     ROT0,   "Capcom", "Dungeons & Dragons: Tower of Doom (Asia 940412)", GAME_SUPPORTS_SAVE )
...
GAME( 1993, ddtodar1,   ddtod,    cps2, cps2_4p4b, cps2,     ROT0,   "Capcom", "Dungeons & Dragons: Tower of Doom (Asia 940113)", GAME_SUPPORTS_SAVE )
//
...
GAME( 1994, armwara,    armwar,   cps2, cps2_3p3b, cps2,     ROT0,   "Capcom", "Armored Warriors (Asia 941024)", GAME_SUPPORTS_SAVE )
GAME( 1994, armwarar1,  armwar,   cps2, cps2_3p3b, cps2,     ROT0,   "Capcom", "Armored Warriors (Asia 940920)", GAME_SUPPORTS_SAVE )
//
GAME( 1994, xmcota,     0,        cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men: Children of the Atom (Euro 950331)", GAME_SUPPORTS_SAVE )
...
GAME( 1994, xmcotar1,   xmcota,   cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men: Children of the Atom (Euro 950105)", GAME_SUPPORTS_SAVE )
//
...
GAME( 1995, sfzar1,     sfa,      cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Street Fighter Zero (Asia 950605)", GAME_SUPPORTS_SAVE )
//
...
GAME( 1996, 19xxa,      19xx,     cps2, cps2_2p2b, cps2,     ROT270, "Capcom", "19XX: The War Against Destiny (Asia 960104)", GAME_SUPPORTS_SAVE )
GAME( 1996, 19xxj,      19xx,     cps2, cps2_2p2b, cps2,     ROT270, "Capcom", "19XX: The War Against Destiny (Japan 960104, Yellow case)", GAME_SUPPORTS_SAVE )
GAME( 1996, 19xxjr1,    19xx,     cps2, cps2_2p2b, cps2,     ROT270, "Capcom", "19XX: The War Against Destiny (Japan 951225)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, 19xxar1,    19xx,     cps2, cps2_2p2b, cps2,     ROT270, "Capcom", "19XX: The War Against Destiny (Asia 951207)", GAME_SUPPORTS_SAVE )
GAME( 1996, 19xxjr2,    19xx,     cps2, cps2_2p2b, cps2,     ROT270, "Capcom", "19XX: The War Against Destiny (Japan 951207)", GAME_SUPPORTS_SAVE )
//
...
GAME( 1996, sfz2j,      sfa2,     cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Street Fighter Zero 2 (Japan 960430)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, sfz2jr1,    sfa2,     cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "Street Fighter Zero 2 (Japan 960227)", GAME_SUPPORTS_SAVE )
//
...
//
GAME( 1996, spf2t,      0,        cps2, cps2_2p2b, cps2,     ROT0,   "Capcom", "Super Puzzle Fighter II Turbo (Euro 960531)", GAME_SUPPORTS_SAVE )
GAME( 1996, spf2tu,     spf2t,    cps2, cps2_2p2b, cps2,     ROT0,   "Capcom", "Super Puzzle Fighter II Turbo (USA 960620)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, xmvsfur2,   xmvsf,    cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men Vs. Street Fighter (USA 960910)", GAME_SUPPORTS_SAVE )
...
GAME( 1996, xmvsfar1,   xmvsf,    cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men Vs. Street Fighter (Asia 961004)", GAME_SUPPORTS_SAVE )
GAME( 1996, xmvsfar2,   xmvsf,    cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men Vs. Street Fighter (Asia 960919)", GAME_SUPPORTS_SAVE )
GAME( 1996, xmvsfar3,   xmvsf,    cps2, cps2_2p6b, cps2,     ROT0,   "Capcom", "X-Men Vs. Street Fighter (Asia 960910)", GAME_SUPPORTS_SAVE )
...
ROM_START( 1944d )	/* 1944 - The Loop Master (2000.06.20 USA Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( 19xxd )	/* 19XX - the war against destiny (1995.12.07, USA Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2ad )	/* Street Fighter Zero 2 (1996.02.27 Asia, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( avspd )	/* Alien vs Predator (1994.05.20 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( batcird )	/* Battle Circuit (1997.03.19 Euro Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddtodd )	/* Dungeons & Dragons - tower of doom (1994.04.12 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ddsomud )	/* Dungeons & Dragons - shadow over mystara (1996.06.19 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ecofghtrd )	/* Eco Fighters (1993.12.03 World, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawingjd )	/* Giga Wing (1999.02.23 Japan, Phoenix Edition) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( gigawingd )	/* Giga Wing (1999.02.22 USA, Phoenix Edition) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( hsf2d )	/* Hyper Street Fighters II: The Anniversary Edition (2004.02.02 Asia, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( megamn2d )	/* Mega Man 2 - the power fighters (1996.07.08 USA, Phoenix Edition) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mvscud )	/* Marvel vs Capcom - clash of super heroes (1998.01.23 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( nwarrud )	/* Night Warriors - darkstalkers' revenge (1995.04.06 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ringdstd )	/* Ring of Destruction - slammasters II (1994.09.02 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfad )	/* Street Fighter Alpha - warriors' dreams (1995.07.27 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshud )	/* Marvel Super Heroes (1995.10.24 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2ald )	/* Street Fighter Zero 2 Alpha (1996.08.26 Asia, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfa3ud )	/* Street Fighter Alpha 3 (1998.09.04 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2xjd )	/* Super Puzzle Fighter II Turbo (1996.05.31 Japan, Phoenix Edition) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsavd )	/* Vampire Savior - the lord of vampire (1997.05.19 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmcotar1d )	/* X-Men - children of the atom (1995.01.05 Euro, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( xmvsfu1d )	/* X-Men vs Street Fighter (1996.10.04 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dstlku1d )	/* Darkstalkers - the night warriors (1994.07.05 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progearud )	/* Progear (2001.01.17 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progearjd )	/* Progear No Arashi (2001.01.17 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( progearjbl )	/* Progear No Arashi (2001.01.17 Japan, decrypted set) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( halfway )	/* Halfway To Hell: Progear Red Label (2016.01.17, Red label ver) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )	 /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "halfway.03", 0x000000, 0x80000, CRC(55ce8d4a) SHA1(3b7342afbfa1244cb5cbf5be7391d3e1f8231822) )
	ROM_LOAD16_WORD_SWAP( "tohell.04",  0x080000, 0x80000, CRC(71060b9e) SHA1(007a174ceca6ae080f19f088bf0fc6cd0fe2510c) )

	ROM_REGION( 0x1000000, "gfx", 0 )
	ROMX_LOAD( "redlabel.13m",   0x000000, 0x400000,  CRC(5194c198) SHA1(f9ae16cad8b30547b8dd3a1ea1d6e845d76ccefe) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "redlabel.15m",   0x000002, 0x400000,  CRC(b794e83f) SHA1(0332fa798b2955464ab336929866c9185bd4b520) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "redlabel.17m",   0x000004, 0x400000,  CRC(87f22918) SHA1(7f048d66593f385526bd2c669cf6b8ad58d12bbf) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "redlabel.19m",   0x000006, 0x400000,  CRC(65ffb45b) SHA1(9c21187519c1ec95c5a960b2c815ee41ace4fa7e) , ROM_GROUPWORD | ROM_SKIP(6) )
	...
	ROM_LOAD16_WORD_SWAP( "redlabel.12m",   0x400000, 0x400000, CRC(47f25cf4) SHA1(714b5baf146d720cc86f77aeee5b1160f553d958) )
ROM_END

ROM_START( ssf2ud )	/* Super Street Fighter II - the new challengers (1993.09.11 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tbd )	/* Super Street Fighter II - the tournament battle (1993.11.19 ETC, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2xjd )	/* Super Street Fighter II X - grand master challenge (1994.02.23 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( ssf2tad )	/* Super Street Fighter II Turbo (1994.02.23 Asia, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sgemfd )	/* Super Gem Fighter Mini Mix (1997.09.04 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( armwar1d )	/* Armored Warriors (1994.10.11, Europe, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( dimahoud )	/* Dimahoo (2000.01.21 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mmatrixd )	/* Mars Matrix (2000.04.12 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vhunt2d )	/* Vampire Hunter 2 - darkstalkers revenge (1997.09.13 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( vsav2d )	/* Vampire Savior 2 - the lord of vampire (1997.09.13 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( csclub1d )	/* Capcom Sports Club (1997.07.22 Euro Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( cybotsud )	/* Cyberbots - fullmetal madness (1995.04.24 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( cybotsjd )	/* Cyberbots - fullmetal madness (1995.04.24 Japan, decrypted bootleg) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( mshvsfu1d )	/* Marvel Super Heroes vs Street Fighters (1997.06.25 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( spf2td )	/* Super Puzzle Fighter II Turbo (1996.06.20 USA, Phoenix Edition) */
	ROM_REGION(CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz3jr2d )	/* Street Fighter Zero 3 (1998.06.29 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfz2jd )	/* Street Fighter Zero 2 (1996.02.27 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
...
ROM_START( sfaud )	/* Street Fighter Alpha - warrior's dreams (1995.07.27 USA, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfzud.03a", 0x000000, 0x80000, CRC(9f2ff577) SHA1(e78d7e8e0a5703dea09aed2ac4055d45844cead5) )
	ROM_LOAD16_WORD_SWAP( "sfz.04b",   0x080000, 0x80000, CRC(8b73b0e5) SHA1(5318761f615c21395366b5333e75eaaa73ef2073) )
	ROM_LOAD16_WORD_SWAP( "sfz.05a",   0x100000, 0x80000, CRC(0810544d) SHA1(5f39bda3e7b16508eb58e5a2e0cc58c09cf428ce) )
	ROM_LOAD16_WORD_SWAP( "sfz.06",    0x180000, 0x80000, CRC(806e8f38) SHA1(b6d6912aa8f2f590335d7ff9a8214648e7131ebb) )
...
ROM_START( ssf2td )	/* Super Street Fighter II Turbo (1994.02.23 ETC, Phoenix Edition)  */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "sfxed.03c", 0x000000, 0x80000, CRC(ed99d850) SHA1(d2dcb8395d630fcd1776fd32a9c685646e1f18be) )
	ROM_LOAD16_WORD_SWAP( "sfxed.04a", 0x080000, 0x80000, CRC(38d9b364) SHA1(814e67441a9d92ed89edf20dacb17a0f100020e3) )
	ROM_LOAD16_WORD_SWAP( "sfxed.05",  0x100000, 0x80000, CRC(c63358d0) SHA1(dde4d9e9adce4dee02322c0fd71615eed0af62e6) )
	ROM_LOAD16_WORD_SWAP( "sfxed.06a", 0x180000, 0x80000, CRC(ccb29808) SHA1(10e7b135a936409fe7c4d7959ea375634a8c68e4) )
	ROM_LOAD16_WORD_SWAP( "sfxed.07",  0x200000, 0x80000, CRC(61f94982) SHA1(d2f22f50c21393deda7d5838dbd2b265722acd38) )
	ROM_LOAD16_WORD_SWAP( "sfxed.08",  0x280000, 0x80000, CRC(d399c36c) SHA1(b4c4217843e5c3ef00ab04d58ca9368d2d734065) )
	ROM_LOAD16_WORD_SWAP( "sfxed.09",  0x300000, 0x80000, CRC(317b5dbc) SHA1(1e1037b071251c28ed9cd5ccd6d52b72cc86396a) )
...
ROM_START( ssf2d )	/* Super Street Fighters II - the new challengers (1993.09.11 ETC, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "ssfed.03",  0x000000, 0x80000, CRC(fad5daf8) SHA1(5bed5d5af8dffc54d3b3371274a3905f46384f79) )
	ROM_LOAD16_WORD_SWAP( "ssfed.04",  0x080000, 0x80000, CRC(0d31af65) SHA1(7e903e18cb899627fedd8ad92594b75b5d8ee8fd) )
	ROM_LOAD16_WORD_SWAP( "ssfed.05",  0x100000, 0x80000, CRC(75c651ef) SHA1(8c6f60d3cf10d802190438c403a719bc30ccbeaa) )
	ROM_LOAD16_WORD_SWAP( "ssfed.06",  0x180000, 0x80000, CRC(85c3ec00) SHA1(29ab3eccc5f9c0dd6bd19eaa83c72e1a1d44b320) )
	ROM_LOAD16_WORD_SWAP( "ssfed.07",  0x200000, 0x80000, CRC(9320e350) SHA1(bec5dcd85faf10c72cc79e5d5af311ffb5445c47) )
...
ROM_START( mpangjd )	/* Mighty! Pang (2000.10.11 Japan, Phoenix Edition) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "mpnj-pnx.03", 0x000000, 0x80000, CRC(dac63128) SHA1(e5ee8f6d698a28dbf54520473520e40efadf30e3) )
	ROM_LOAD16_WORD_SWAP( "mpnj-pnx.04", 0x080000, 0x80000, CRC(d0b2592b) SHA1(f18c026776326f9bab70d1a8f66dd5fffb115b1b) )
...
ROM_START( 1944ad )	/* Phoenix Edition, 1944 - the loop master (USA 000620, alt) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "nffuad.03", 0x000000, 0x80000, CRC(78188e42) SHA1(add31daba3e6916a1facfaf32feeaba228e9a6ab) )
	ROM_LOAD16_WORD_SWAP( "nff.04",	   0x080000, 0x80000, CRC(dba1c66e) SHA1(4764e77d4da5d19d9acded27df1e1bcba06b0fcf) )
	ROM_LOAD16_WORD_SWAP( "nffu.05",   0x100000, 0x80000, CRC(ea813eb7) SHA1(34e0175a5f22d08c3538369b4bfd077a7427a128) )
...
ROM_START( hsf2da )	/* Hyper Street Fighters II: The Anniversary Edition (2004.02.02 Asia, Phoenix Edition, alt) */
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "hs2ad.03",  0x000000, 0x80000, CRC(0153d371) SHA1(137f89b4ca41346abd8d1ef4a17605f6622b741e) )
	ROM_LOAD16_WORD_SWAP( "hs2ad.04",  0x080000, 0x80000, CRC(0276b78a) SHA1(3f5502f77eb9889ca4658eb323579e05b35c9868) )
	ROM_LOAD16_WORD_SWAP( "hs2.05",    0x100000, 0x80000, CRC(dde34a35) SHA1(f5be2d2916db6e86e0886d61d55bddf138273ebc) )
	...
	ROM_REGION( 0x2000000, "gfx", 0 )
	ROMX_LOAD( "hs2.13",   0x0000000, 0x400000, CRC(6ff7f5f1) SHA1(e99af47ff4999f24649e73682d112bac71889502) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.15",   0x0000002, 0x400000, CRC(26da2f5d) SHA1(9f8f855a0f0805460f85a5ae9faee0ea37ace0af) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.17",   0x0000004, 0x400000, CRC(e769ee8e) SHA1(824be1da9532eb9b283ec68b2e5ec4724452d9fd) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.19",   0x0000006, 0x400000, CRC(7f47fd07) SHA1(27cfc4d72bbbef10a7693f4d682d652398458b3b) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.14",   0x1000000, 0x400000, CRC(c549e333) SHA1(efc56497706d6b6818380dfdff766810ed76813a) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.16",   0x1000002, 0x400000, CRC(0a8541f9) SHA1(c5dd90d4011edcbdd40f2f51faa72be6fad023b1) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.18",   0x1000004, 0x400000, CRC(f4c92b27) SHA1(1108e3303ba8351bf9e718a928ab4b4b02a9a36a) , ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "hs2.20",   0x1000006, 0x400000, CRC(ba355a75) SHA1(ec424428eba5e6cb41609041bc7876dcf43b8018) , ROM_GROUPWORD | ROM_SKIP(6) )
	...
	ROM_REGION( 0x800000, "qsound", 0 )
	ROM_LOAD16_WORD_SWAP( "hs2(__hsf2da).11m", 0x000000, 0x400000, CRC(5cb00496) SHA1(8008adef760bdda19ccecb254b6dc2e9dbc15538) )
	ROM_LOAD16_WORD_SWAP( "hs2.12m",	   0x400000, 0x400000, CRC(8f298007) SHA1(bf7819f935a91c2d3bd00090fb438e468b3ef0e7) )
ROM_END


/*
GAME( year, archives name, parent, MACHINE_DRIVER_START, INPUT_PORTS, DRIVER_INIT,  flip,  producer name,  title information,  status )
*/
...
//
GAME( 2001,   progearjd,   progear,  dead_cps2,   cps2_2p3b,   cps2,     ROT0,   "bootleg", "Progear no Arashi (Japan 010117 Phoenix Edition) (bootleg)", GAME_SUPPORTS_SAVE ) /* doesn't display phoenix edition screen, hacked bootleg? */
...
GAME( 2016,   halfway,	   progear,  dead_cps2,   cps2_2p3b,   cps2,	 ROT0,	 "bootleg", "Halfway To Hell: Progear Red Label (2016-1-17 Red label ver)", GAME_SUPPORTS_SAVE )
//
...
//
GAME( 1994,   xmcotar1d,   xmcota,   dead_cps2,   cps2_2p6b,   cps2,     ROT0,   "bootleg", "X-Men: Children of the Atom (Euro 950105 Phoenix Edition) (bootleg)", GAME_SUPPORTS_SAVE )
//
...
//
GAME( 1993,   ecofghtrd,   ecofghtr, dead_cps2,   cps2_2p3b,   cps2,     ROT0,   "bootleg", "Eco Fighters (ETC 931203 Phoenix Edition) (bootleg)", GAME_SUPPORTS_SAVE )
//
