...
static WRITE16_HANDLER( wwfwfest_scroll_write )
{
	...
	{
		case 0x00:
			state->wwfwfest_bg0_scrollx = data;
			break;
		case 0x01:
			state->wwfwfest_bg0_scrolly = data;
			break;
		case 0x02:
			state->wwfwfest_bg1_scrollx = data;
			break;
		case 0x03:
			state->wwfwfest_bg1_scrolly = data;
			break;
	}
}
...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x0c0000, 0x0c1fff) AM_RAM_WRITE(wwfwfest_fg0_videoram_w) AM_BASE_MEMBER(wwfwfest_state, wwfwfest_fg0_videoram)	/* FG0 Ram - 4 bytes per tile */
	AM_RANGE(0x0c2000, 0x0c3fff) AM_RAM AM_BASE_SIZE_GENERIC(spriteram)								/* SPR Ram */
	AM_RANGE(0x080000, 0x080fff) AM_RAM_WRITE(wwfwfest_bg0_videoram_w) AM_BASE_MEMBER(wwfwfest_state, wwfwfest_bg0_videoram)	/* BG0 Ram - 4 bytes per tile */
	AM_RANGE(0x082000, 0x082fff) AM_RAM_WRITE(wwfwfest_bg1_videoram_w) AM_BASE_MEMBER(wwfwfest_state, wwfwfest_bg1_videoram)	/* BG1 Ram - 2 bytes per tile */
...
static const gfx_layout tile_layout = {
	...
	{ STEP8(0, 1), STEP8(32*8,1) },
	{ STEP8(0,16), STEP8(16*8,16) },
...
static MACHINE_DRIVER_START( wwfwfest )
	/* driver data */
	MDRV_DRIVER_DATA(wwfwfest_state)
	...
	MDRV_MACHINE_START(wwfwfest)
	MDRV_MACHINE_RESET(wwfwfest)
...
GAME( 1991,  wwfwfestj,  wwfwfest,  wwfwfest,  wwfwfesta, 0,  ROT0, "Technos Japan (Tecmo license)", "WWF WrestleFest (Japan)", GAME_SUPPORTS_SAVE )
GAME( 1991,  wwfwfestk,  wwfwfest,  wwfwfest,  wwfwfesta, 0,  ROT0, "Technos Japan (Tecmo license)", "WWF WrestleFest (Korea)", GAME_SUPPORTS_SAVE )
