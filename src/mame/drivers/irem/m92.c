...
Dip locations verified for:
    - gunforce, inthunt, majtitl2, uccops [manual]
...
static MACHINE_CONFIG_START( m92, m92_state )
	...
	MDRV_SOUND_ADD("irem", IREMGA20, XTAL_3_579545MHz)
...
ROM_START( inthunt )	/* In The Hunt (World) */
	...
	ROM_REGION( 0x100000, "soundcpu", 0 )	/* Irem D8000011A1 */
...
static DRIVER_INIT( m92_majtitl2 )
{
	init_m92(machine, 1);
...
static DRIVER_INIT( m92_lethalth )
{
	init_m92(machine, 0);
